...
void ConfigureStopButton( void ){
	...
	/* Configuracion del pin que indica el apagado automatico */
	Chip_SCU_PinMuxSet(STOP_OUT_SCU_PORT, STOP_OUT_SCU_PIN,(SCU_MODE_INBUFF_EN|SCU_MODE_INACT|SCU_MODE_FUNC0));
	Chip_GPIO_SetPinDIROutput(LPC_GPIO_PORT, STOP_OUT_GPIO_PORT, STOP_OUT_GPIO_PIN);	//Pin de salida
