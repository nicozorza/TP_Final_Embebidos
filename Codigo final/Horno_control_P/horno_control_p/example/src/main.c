...
static void vHandlerStart(void *pvParameters){
    ...
    Board_LED_Set(4, true);		//Se apaga el led de encendido
    Board_LED_Set(5, false);			//Se enciende el led de apagado
	...
	Board_LED_Set(4, false);			//Se enciende un led para indicar que esta encendido
	Board_LED_Set(5, true);		//Se apaga el led de apagado
