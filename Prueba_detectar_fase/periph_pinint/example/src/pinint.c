...
int main(void)
{
	...
	Chip_SCU_PinMuxSet(6, 1,(SCU_MODE_INBUFF_EN | SCU_MODE_INACT | TEST_INPUT_MODE_FUNC) );
	Chip_GPIO_SetPinDIROutput(LPC_GPIO_PORT, 3, 0);	//Pin de salida
	...
	while (1) {
		__WFI();
		delay_zorza(35000);
		Chip_GPIO_SetPinState(LPC_GPIO_PORT, 3, 0,true);
		delay_zorza(5000);
